...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "120", height: "29", href: isDark ? '/images/strike/LogoTextNewDark.png' : '/images/strike/LogoTextNewWhite.png' })));
};
...
var baseColors = {
    failure: "#ED4B9E",
    primary: "linear-gradient(180deg, #443CF8 0%, #5C6BFC 100%);",
    primaryBright: "#4E3BE9",
    primaryDark: "#4E3BE9",
    secondary: "#7645D9",
    success: "#31D0AA",
    warning: "#FFB237",
